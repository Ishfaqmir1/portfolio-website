      ...
      <div className="what-box">
        <div className="what-box-in">
          ...
          >
            ...
            <div className="what-content-in">
              ...
              <p>
                ...
                frameworks and libraries. Experienced in creating RESTful APIs,
                authentication systems, and responsive frontend interfaces.
              </p>
          ...
          >
            ...
            <div className="what-content-in">
              <h3>ARCHITECT</h3>
              <h4>System Design & DevOps</h4>
              <p>
                Designing scalable system architectures, optimizing API
                performance, and managing deployment workflows with CI/CD
